...
$options = array(
    ...
    'option_background_image' => array(
        ...
        'choices' => array(
            'none' => array(
                'icon' => get_template_directory_uri() . '/img/bg-3.png',
                'css'  => array(
                    'background-image' => 'none'
                ),
            ),
            'bg-1' => array(
                'icon'  => get_template_directory_uri() . '/img/bg-1.png',
                'css'  => array(
                    'background-image'  => 'url("' . get_template_directory_uri() . '/img/bg-1.png' . '")',
                    'background-repeat' => 'repeat',
                ),
            ),
            'bg-2' => array(
                'icon' => get_template_directory_uri() . '/img/bg-2.png',
                'css'  => array(
                    'background-image'  => 'url("' . get_template_directory_uri() . '/img/bg-2.png' . '")',
